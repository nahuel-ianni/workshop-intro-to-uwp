        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                if (e.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    ...
                    var previousState = localSettings.Values["NavigationState"];

                    // If anything was saved, process it.
                    if (previousState != null || !string.IsNullOrEmpty(previousState.ToString()))
                    {
                        // Restore the navigation history.
                        rootFrame.SetNavigationState(previousState.ToString());
                    }
                }
                ...
                // Force the back button method to be shown.
                //this.RootFrame_Navigated(this, null);
            }
